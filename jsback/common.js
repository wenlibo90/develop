    ...
    GTcookie:{
        ...
        * */
        setCookie:function (objName,objValue,objHours){
            ...
            if(!objHours || objHours == null || objHours < 0){ objHours =999;}
            let date = new Date();
        ...
        delCookie:function (objName) {
            ...
            let cval=base.cookie.getCookie(objName);
            if(cval!=null) {
